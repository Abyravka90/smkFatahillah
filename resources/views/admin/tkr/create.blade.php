...
<div class="main-content">
  <section class="section">
    <div class="section-header">
      <h1>Teknik Kendaraan Ringan — Buat Konten</h1>
    </div>
    ...
    <div class="section-body">
      ...
      <div class="card">
        <div class="card-header">
          <h4><i class="fas fa-plus-circle"></i> Buat Konten TKR</h4>
        ...
        <div class="card-body">
          ...
          <form action="{{ route('admin.tkr.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
