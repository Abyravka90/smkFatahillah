...
<div class="main-content">
  <section class="section">
    <div class="section-header">
      <h1>Manajemen Perkantoran — Edit Konten</h1>
    </div>

    <div class="section-body">
      <div class="card">
        <div class="card-header">
          <h4><i class="fas fa-pencil-alt"></i> Edit Konten OTKP</h4>
        ...
        <div class="card-body">
          ...
          <form action="{{ route('admin.otkp.update', $otkp->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
              ...
              <textarea id="content"
                        ...
                        placeholder="Tuliskan deskripsi/isi konten…">{{ old('content', $otkp->content) }}</textarea>
              @error('content')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
