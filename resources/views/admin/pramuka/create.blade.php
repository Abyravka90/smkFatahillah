    ...
    <div class="section-body">
      ...
      <div class="card">
        <div class="card-header">
          <h4><i class="fas fa-plus-circle"></i> Buat Konten Pramuka</h4>
        ...
        <div class="card-body">
          ...
          <form action="{{ route('admin.pramuka.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
