...
<div class="main-content">
  <section class="section">
    <div class="section-header">
      <h1>Kepala Sekolah — Edit Konten</h1>
    </div>

    <div class="section-body">
      <div class="card">
        <div class="card-header">
          <h4><i class="fas fa-pencil-alt"></i> Edit Konten Kepala Sekolah</h4>
          <div class="card-header-action">
            <a href="{{ route('admin.kepalasekolah.index') }}" class="btn btn-light">
        ...
        <div class="card-body">
          ...
          <form action="{{ route('admin.kepalasekolah.update', $kepalasekolah->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
              ...
              <textarea id="content"
                        ...
                        placeholder="Tuliskan deskripsi/isi konten…">{{ old('content', $kepalasekolah->content) }}</textarea>
              @error('content')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            @include('admin.partials.division-edit-uploads', ['item' => $kepalasekolah])

            <div class="text-right">
              <a href="{{ route('admin.kepalasekolah.index') }}" class="btn btn-secondary">Batal</a>
