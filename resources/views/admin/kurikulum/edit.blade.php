...
<div class="main-content">
  <section class="section">
    <div class="section-header">
      <h1>Kurikulum — Edit Konten</h1>
    </div>

    <div class="section-body">
      <div class="card">
        <div class="card-header">
          <h4><i class="fas fa-pencil-alt"></i> Edit Konten Kurikulum</h4>
          <div class="card-header-action">
            <a href="{{ route('admin.kurikulum.index') }}" class="btn btn-light">
          ...
          <form action="{{ route('admin.kurikulum.update', $kurikulum->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <textarea id="content"
                        ...
                        placeholder="Tuliskan deskripsi/isi konten…">{{ old('content', $kurikulum->content) }}</textarea>
              @error('content')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
