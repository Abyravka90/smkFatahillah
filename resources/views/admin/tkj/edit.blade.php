...
<div class="main-content">
  <section class="section">
    <div class="section-header">
      <h1>Teknik Kendaraan Ringan — Edit Konten</h1>
    </div>

    <div class="section-body">
      <div class="card">
        <div class="card-header">
          <h4><i class="fas fa-pencil-alt"></i> Edit Konten tkj</h4>
          <div class="card-header-action">
            <a href="{{ route('admin.tkj.index') }}" class="btn btn-light">
        ...
        <div class="card-body">
          ...
          <form action="{{ route('admin.tkj.update', $tkj->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
              ...
              <textarea id="content"
                        ...
                        placeholder="Tuliskan deskripsi/isi konten…">{{ old('content', $tkj->content) }}</textarea>
              @error('content')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="text-right">
              <a href="{{ route('admin.tkj.index') }}" class="btn btn-secondary">Batal</a>
