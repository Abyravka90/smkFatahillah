    ...
    <div class="section-body">
      ...
      <div class="card">
        <div class="card-header">
          <h4><i class="fas fa-book-open"></i> Teknik Pemesinan </h4>
          <div class="card-header-action">
            @if ($cek_tp !== 1)
            <a href="{{ route('admin.tp.create') }}" class="btn btn-success">
              ...
              @forelse ($tps as $no => $tp)
                <tr>
                  ...
                  <td class="text-center">
                      ...
                      <a href="{{ route('admin.tp.edit', $tp->id) }}" class="btn btn-sm btn-primary">
...
<script>
  function confirmDelete(id) {
    ...
    const url   = form ? form.getAttribute('action') : ('/admin/tp/' + id);
